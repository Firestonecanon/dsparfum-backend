...
export default function FemmeSection() {
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Des fragrances élégantes et envoûtantes pour la femme moderne. 
            Chaque parfum révèle votre féminité avec grâce et sophistication.
          </p>
          
          <div className="flex items-center justify-center mt-8">
            <div className="h-px bg-gradient-to-r from-transparent via-pink-500/50 to-transparent w-64"></div>
            <div className="mx-4 w-2 h-2 bg-pink-500 rounded-full"></div>
            <div className="h-px bg-gradient-to-r from-pink-500/50 via-transparent to-transparent w-64"></div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid gap-4 md:gap-6">
            {parfumsFemme.map((parfum, index) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-pink-500/[0.05] to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                  ...
                  <div className="flex-shrink-0 relative">
                    <div className="w-16 h-20 md:w-18 md:h-24 rounded-xl overflow-hidden group-hover:scale-105 transition-transform duration-300 shadow-lg">
                      <img 
                        ...
                        style={{ filter: 'hue-rotate(320deg) saturate(1.3) brightness(1.1)' }}
                      />
                    </div>
                    <div className="absolute -top-1 -right-1 bg-gradient-to-r from-pink-500 to-pink-600 text-white text-xs font-bold px-1.5 py-0.5 rounded-full shadow-lg border border-pink-400">
                      {parfum.publicRef}
                    </div>
                  </div>
                  ...
                  <div className="flex-grow min-w-0">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                      <div className="min-w-0">
                        <h3 className="text-lg md:text-xl font-bold text-white mb-1 truncate group-hover:text-pink-300 transition-colors duration-300">
                          {parfum.name}
                        </h3>
                        <p className="text-pink-300 text-sm md:text-base font-medium">
                          {parfum.brand}
                        </p>
                        <div className="flex items-center gap-2 mt-2">
                          <div className="bg-pink-900/30 border border-pink-500/30 rounded-full px-3 py-1">
                      ...
                      <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <button 
                          ...
                          className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-400 hover:to-pink-500 text-white px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-pink-500/30 whitespace-nowrap relative overflow-hidden group"
                        >
        ...
        <div className="mt-16 text-center">
          <div className="bg-black/90 backdrop-blur-md border border-gray-700/50 rounded-2xl p-6 max-w-4xl mx-auto shadow-2xl" style={{
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              <strong className="text-pink-400">Collection D&S Parfums Femmes - Élégance Premium</strong><br />
