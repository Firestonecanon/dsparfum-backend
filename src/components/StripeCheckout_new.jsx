...
const StripeCheckout = ({ cart, total, onSuccess, onCancel }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Filtrer description vide avant envoi
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="mt-4 text-xs text-gray-500 text-center">
        ...
        <span className="block mt-1 text-orange-500 font-semibold">⚠️ Après avoir cliqué sur "Payer", la fenêtre suivante (saisie CB) peut prendre jusqu'à 30 secondes à s'afficher.<br />Merci de patienter, cela est normal si le serveur est en veille.</span>
      </div>
    </div>
  );
};
