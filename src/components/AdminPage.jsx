...
const AdminPage = () => {
  ...
  const loadClients = async () => {
    setLoading(true);
    try {
      const response = await fetch('https://dsparfum-backend-go.onrender.com/api/clients');
      if (response.ok) {
  ...
  const saveClient = async (clientData) => {
    try {
      ...
      const url = clientData.id 
        ? `https://dsparfum-backend-go.onrender.com/api/admin/clients/${clientData.id}` 
        : 'https://dsparfum-backend-go.onrender.com/api/admin/clients';
  ...
  const deleteClient = async (clientId) => {
    if (window.confirm('Êtes-vous sûr de vouloir supprimer ce client ?')) {
      try {
        const response = await fetch(`https://dsparfum-backend-go.onrender.com/api/admin/clients/${clientId}`, {
          method: 'DELETE',
        });
        if (response.ok) {
          loadClients();
  ...
  const exportClients = async () => {
    try {
      const response = await fetch('https://dsparfum-backend-go.onrender.com/api/admin/export');
