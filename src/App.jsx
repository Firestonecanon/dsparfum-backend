...
export default function App() {
  // Vérifier les paramètres URL pour les pages de paiement et admin
  const urlParams = new URLSearchParams(window.location.search);
  const paymentStatus = urlParams.get('payment');
  const currentPath = window.location.pathname;

  // Si c'est la page admin, afficher AdminPage
          ...
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white shadow-xl overflow-hidden border-b border-amber-400/30">
            ...
            <div className="hidden md:block py-3 px-6 text-center text-sm font-medium">
              <div className="flex items-center justify-center gap-6 flex-wrap">
                <span className="inline-block flex items-center gap-1">✨ <strong className="text-amber-300">Format 70ml + 15ml offert</strong></span>
                <span className="inline-block text-amber-400">•</span>
                <span className="inline-block flex items-center gap-1">🎁 <strong className="text-amber-300">FDP :</strong> 9€ / -50% / Offert</span>
                <span className="inline-block text-amber-400">•</span>
                <span className="inline-block flex items-center gap-1">👜 <strong className="text-amber-300">Étui 15ml :</strong> 15€ (recommandé)</span>
                <span className="inline-block text-amber-400">•</span>
                <span className="inline-block flex items-center gap-1">💎 <strong className="text-amber-300">Qualité premium garantie</strong></span>
              </div>
            </div>
