...
export default function HommeSection() {
  const { addToCart } = useCart();

  const handleAddToCart = (parfum) => {
    const product = {
      id: `homme-${parfum.ref}`,
      ref: parfum.publicRef,        // Stripe recevra bien la référence commerciale
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Des senteurs puissantes et affirmées pour l'homme moderne. 
            Chaque fragrance exprime la force tranquille et l'assurance.
          </p>
          ...
          <div className="flex items-center justify-center mt-8">
            ...
            <div className="h-px bg-gradient-to-r from-blue-500/50 via-transparent to-transparent w-64"></div>
          </div>
        </div>

        <div className="max-w-6xl mx-auto">
          <div className="grid gap-4 md:gap-6">
            {parfumsHomme.map((parfum, index) => (
              <div 
                key={parfum.id}
                className="group bg-black/90 backdrop-blur-md border border-gray-700/50 rounded-2xl p-4 md:p-6 hover:border-blue-500/40 transition-all duration-500 hover:transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/10 relative overflow-hidden"
                style={{
                  boxShadow: '0 8px 32px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(245, 158, 11, 0.08)'
                }}
              >
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-500/[0.03] to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                  ...
                  <div className="flex-shrink-0 relative">
                    <div className="w-16 h-20 md:w-18 md:h-24 rounded-xl overflow-hidden group-hover:scale-105 transition-transform duration-300 shadow-lg">
                      <img 
                        ...
                        style={{ filter: 'hue-rotate(200deg) saturate(1.2) brightness(0.9)' }}
                      />
                    </div>
                    <div className="absolute -top-1 -right-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs font-bold px-1.5 py-0.5 rounded-full shadow-lg border border-blue-400">
                      {parfum.publicRef}
                    </div>
                  </div>
                  ...
                  <div className="flex-grow min-w-0">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                      <div className="min-w-0">
                        <h3 className="text-lg md:text-xl font-bold text-white mb-1 truncate group-hover:text-blue-300 transition-colors duration-300">
                          {parfum.name}
                        </h3>
                      ...
                      <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <button 
                          ...
                          className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30 whitespace-nowrap relative overflow-hidden group"
                        >
        ...
        <div className="mt-16 text-center">
          <div className="bg-black/90 backdrop-blur-md border border-gray-700/50 rounded-2xl p-6 max-w-4xl mx-auto shadow-2xl" style={{
            boxShadow: '0 12px 40px rgba(0, 0, 0, 0.8), inset 0 1px 0 rgba(245, 158, 11, 0.12)'
          }}>
            <p className="text-sm text-gray-300 leading-relaxed">
              <strong className="text-blue-400">Collection D&S Parfums Hommes - Qualité Premium</strong><br />
